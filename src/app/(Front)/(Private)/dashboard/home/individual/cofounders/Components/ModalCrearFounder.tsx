...
import { dataCargosStartUps } from "../../empleados/utils/dataCargosStartUps";
//import { dataCargosStartUps } from "../utils/dataCargosStartUps";


const ModalCrearFounder = ({setActivarFounder}) => {
          ...
          <form   className={`bg-white w-[23%] h-[70%] py-4 px-10  rounded-md mt-8 shadow-2xl fixed top-14 grid justify-self-center text-(length:--tamañoLetraChica)`}>
                ...
                <main className='h-[100%] grid grid-rows-7 -mt-10 '>
                  <div className="flex -ml-1 ">
                    <div>
                      <img className="w-5 h-5" src="https://roudev-s3-assets.s3.us-east-1.amazonaws.com/AssetsRoudev/Icons/comida.png" alt="" />
                    </div>
...
export default ModalCrearFounder